...
include '../koneksi.php';
$no = 1;
$query = mysqli_query($conn,"SELECT * FROM tb_barang a INNER JOIN tb_satuan b ON a.satuan=b.id_satuan INNER JOIN tb_jenis c ON a.jenis=c.id_jenis") or die(mysqli_error($conn));
